...
Pandas的DataFrame对象可以直接打印出来
 ...
 ![purchaseRedeemTotal](/images/purchaseRedeemTotalPlot.jpg)
...
>b. 差分  
 ...
 比差分之前有所改善,让我们接着往下走.  
>c. 选择p, q, 训练模型, 预测  
 d已经确定为1, 看图猜数字, p根据PACF大概确定为7, q根据ACF选为5, 开始训练模型并预测
...
2. 基于组合预测的风电场风速及风电机功率预测-张国强, 张伯民. 搜组合预测的时候无意中搜到的, 发现风电方面与实践序列相关的研究也不少. 这篇主要说了神经网络(分段线性法, 好像很高端, 暂时还没高明白)以及组合预测, 不过组合预测的公式好像有点问题大家可以再看看. 
